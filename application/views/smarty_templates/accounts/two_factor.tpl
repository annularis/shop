            <div class="col-lg-9">  
                ...
                <div class="card bg-light card-body mb-3">
                    ...
                    <div class='row'>
                        <div class='col-lg-2'><strong>Current Setting</strong></div>
                        <div class='col-lg-4'><u>{if $two_factor_setting == TRUE}Enabled{else}Disabled{/if}</u></div>
                    </div>
                    <hr />
                            ...
                            <div class='col-12'>
                                ...
                                {form method="open" action="account/two_factor" attr=['class'=>'form-horizontal','name' => 'totp_form']}
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-9 mx-lg-auto col-12'><img src='data:image/png;base64,{$qr}'></div>
                                        <div class='col-lg-10 mx-lg-auto col-12'>Secret Key: {$secret}</div>
                                        <p>2 - Enter the generated token and your password to confirm:</p>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-12">
                                            <label class="control-label col-2" for="password"></label>
                                            <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-12">
                                            <label class="control-label col-2" for="token"></label>
                                            <div class="col-6">
                                                <input type='text' class="form-control" name='totp_token' value='' placeholder="Token" autocomplete="off" />
                                            </div>
                                        </div>
                                        <div class="col-10 mx-auto">{form method="form_error" field="totp_token"}</div>
                                    </div>
                            ...
                            <div class='col-12'>
                                ...
                                <div class='row'>
                                    {if $two_factor.pgp == TRUE}
                                        ...
                                        {url type="anchor" url="account/disable_2fa" text="Click here to disable this!" attr='class="btn btn-danger"'}
                                    {else}
                                        <div class='col-lg-12'>PGP-based two factor challenges ensure that your account can only be accessed by someone able to decrypt messages encrypted with your PGP public key.</div>
                                        <div class='col-lg-12'>{url type="anchor" url="account/pgp_factor" text="Setup" attr='class="btn btn-default"'}</div>
                                    {/if}
                                </div>
                                {else}
