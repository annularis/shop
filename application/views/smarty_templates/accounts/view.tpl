            ...
            <div class="col-lg-9" id="view-account">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">{$user.location_f}</div>
                    </div>

                    <div class="row">
                        <div class="col-lg-3"><strong>Registered</strong></div>
                        <div class="col-lg-7">{$user.register_time_f}</div>
                    </div>

                    {if $user.display_login_time == '1'}
                    <div class="row">
                        <div class="col-lg-3"><strong>Last Activity</strong></div>
                        <div class="col-lg-7">{$user.login_time_f}</div>
                    </div>
                    {/if}

                    <div class="row">
                        <div class="col-lg-3"><strong>Average Rating</strong></div>
                        <div class="col-lg-7">{$average_rating}</div>
                    </div>

                    <div class="row">
                        <div class='col-lg-3'><strong>Completed Orders</strong></div>
                        <div class='col-lg-7'>{$user.completed_order_count}</div>
                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-6">
                                            {foreach from=$review.rating key=quality item=rating}
                                                <div class="col-lg-12">
                                                    <div class="col-lg-7">{ucfirst($quality)}</div>
                                                    <div class="col-lg-5">{rating rating=$rating}</div>
                                                </div>
                                            {/foreach}
                                            <div class="col-lg-12">
                                                <div class="col-lg-7">Average</div>
                                                <div class="col-lg-5">{rating rating=$review.average_rating}</div>
                                            </div>
                                        </div>
                    ...
                    <div class="card bg-light card-body mb-3" style="background:white">
                        ...
                        <div class='col-3'>{url type="anchor" url=$smarty.capture.t_item_url text=$item.name|escape:"html":"UTF-8" attr=""}</div>
                    ...
                    <div class="row">
                        <div class="col-3"><strong>PGP Fingerprint</strong></div>
                        <div class="col-7">{substr($user.pgp.fingerprint, 0, -8)}<b>{substr($user.pgp.fingerprint,-8)}</b></div>
                    </div>

                    <div class="row">
                        <div class="col-lg-3"><strong>PGP Public Key</strong></div>
                        <div class="col-9">
                            <pre id="publicKeyBox" class="card bg-light card-body mb-3">{$user.pgp.public_key|escape:"html":"UTF-8"}</pre>
                        </div>
                    </div>
                    {/if}
            </div>