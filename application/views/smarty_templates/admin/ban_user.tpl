            ...
            <div class="col-9" id="admin_ban_user">
                <h2>Ban User</h2>
                ...
                {form method="open" action=$smarty.capture.t_ban_user_url attr='class="form-horizontal"'}
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-3" for="ban_user">Are you sure?</label>
                            <div class="col-7">
                        ...
                        <span class="col-9 mx-auto">{form method="form_error" field='ban_user'}</span>
                    </div>
