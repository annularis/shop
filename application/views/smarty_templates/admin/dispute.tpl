            ...
            <div class="col-lg-9" id="dispute-form">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-6">{$current_order.created_time_f}</div>
                            </div>
                            <div class="row">
                                <div class="col-6"><strong>Amount Paid</strong></div>
                                <div class="col-6">{$coin.symbol} {number_format($current_order.order_price, 8)}</div>
                            </div>
                            <div class="row">
                                <div class="col-6"><strong>Disputing User</strong></div>
                                <div class="col-6">{url type="anchor" url=$smarty.capture.t_disputing_user_url text=$disputing_user.user_name|escape:"html":"UTF-8" attr=''}</div>
                            </div>
                        </div>
                ...
                <div class="well">
                    ...
                    {form method="open" action=$smarty.capture.t_dispute_url attr='class="form-horizontal"'}
                        <div class="row">
                            <div class="col-3"><strong>Initial Dispute</strong></div>
                            <div class="col-5">{$dispute.dispute_message|escape:"html":"UTF-8"}</div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">{$update.message|escape:"html":"UTF-8"}</div>
                            </div><br />
                            {/foreach}
                        </div>
                        {/if}
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <label class="control-group col-2" for="update_message">Response</label>
                                <div class="col-9"><textarea name="update_message" id="update_message" class="form-control"></textarea></div>
                            </div>
                            <div class="col-10 mx-auto">{form method="form_error" field="update_message"}</div>
                        </div>
                    ...
                    {form method="open" action=$smarty.capture.t_dispute_url attr='class="form-horizontal"'}
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="col-6"><strong>Order Price:</strong></div>
                                <div class="col-6">{$coin.symbol} {$current_order.order_price}</div>
                                <div class="col-6"><strong>Transaction Fee:</strong></div>
                                <div class="col-6">{$coin.symbol} {$transaction_fee}</div>
                                <div class="col-6"><strong>Admin Fee's:</strong></div>
                                <div class="col-6">{$coin.symbol} {$admin_fee}</div>
                                <div class="col-6"><strong>User Funds:</strong></div>
                                <div class="col-6">{$coin.symbol} {$user_funds}</div>
                            ...
                            <div class="col-6">
                                ...
                                {else}
                                    {if $current_order.vendor_selected_escrow == "1"}
                                        <div class="row">
                                            <div class="col-5"><strong>Pay {$current_order.buyer.user_name|escape:"html":"UTF-8"}:</strong></div>
                                            <div class="col-6"><input type="text" name="pay_buyer" class="form-control" value="" /></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-5"><strong>Pay {$current_order.vendor.user_name|escape:"html":"UTF-8"}:</strong></div>
                                            <div class="col-6"><input type="text" name="pay_vendor" class="form-control" value="" /></div>
                                        </div>

                                        <div class="col-12">Distribute the entire User Funds balance appropriately between the two users.</div>
                                    {else}
