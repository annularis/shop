            <div class="col-lg-9" id="edit_general">
                ...
                {form method="open" action="admin/edit/items" attr='class="form-horizontal"'}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <label class="control-label col-lg-1">Add:</label>
                            <div class="col-lg-9">
                                <div class="col-lg-6">
                            ...
                            <div class="col-lg-2"><input type='submit' name='add_category' value='Add' class='btn btn-primary btn-block' /></div>
                        </div>
                        <div class="col-8 mx-auto">{form method="form_error" field="create_name"}
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-lg-1">Rename:</label>
                            <div class="col-lg-9">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i>Name</i></span>
                            ...
                            <div class="col-lg-2"><input type='submit' name='rename_category' value='Rename' class='btn btn-primary btn-block' /></div>
                        </div>
                        <div class="col-8 mx-auto">{form method="form_error" field="rename_id"}
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-lg-1">Delete:</label>
                            <div class="col-lg-9">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i>Name</i></span>
