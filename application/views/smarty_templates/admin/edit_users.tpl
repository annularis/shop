            <div class="col-lg-9" id="admin_edit_users">
                ...
                {form method="open" action="admin/edit/users" attr='class="form-horizontal"'}
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="login_timeout">Session Timeout</label>
                            <div class="col-3">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="login_timeout"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="request_emails">Request Emails?</label>
                            <div class="col-5">
                                <div class="input-group">
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="captcha_length">Captcha Length</label>
                            <div class="col-3">
                                <div class="input-group">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="captcha_length"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="registration_allowed">Registration Allowed?</label>
                            <div class="col-7">
                                <label class="radio-inline">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="registration_allowed"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="vendor_registration_allowed">Vendor Registration Allowed?</label>
                            <div class="col-7">
                                <label class="radio-inline">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="vendor_registration_allowed"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="entry_payment_vendor">Vendor Registration Fee</label>
                            <div class="col-4">
                                <div class="input-group">
                            ...
                            <div class="col-4"><input type='checkbox' name='entry_payment_vendor_disabled'{if $config.entry_payment_vendor == 0} checked {/if} value="1"/> Disabled</div>
                        </div>
                        <div class='col-8 mx-auto'>{form method="form_error" field="entry_payment_vendor"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="entry_payment_buyer">Buyer Registration Fee</label>
                            <div class="col-4">
                                <div class="input-group">
                                    <span class="input-group-addon"><i>{$coin.code}</i></span>
                            ...
                            <div class="col-4"><input type='checkbox' name='entry_payment_buyer_disabled'{if $config.entry_payment_buyer == 0} checked {/if} value="1"/> Disabled</div>
                        </div>
                        <div class='col-12 col-lg-8 mx-md-auto'>{form method="form_error" field="entry_payment_buyer"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="encrypt_private_messages">Encrypt Private Messages?</label>
                            <div class="col-7">
                                <label class="radio-inline">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="encrypt_private_messages"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-4" for="force_vendor_pgp">Force Vendor PGP?</label>
                            <div class="col-7">
                                <label class="radio-inline">
                        ...
                        <div class='col-8 mx-auto'>{form method="form_error" field="force_vendor_pgp"}</div>
                    </div>
