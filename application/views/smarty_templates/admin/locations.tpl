            <div class="col-lg-9" id="admin-locations-form">
                ...
                {form method="open" action="admin/locations" attr='class="form form-horizontal"'}
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-2" for="location_source">List</label>
                            <div class="col-6">
                ...
                {form method="open" action="admin/locations" attr='class="form-horizontal"'}
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-2" for="location_source">Add:</label>
                            <div class="col-9">
                                <div class="col-6">
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-2" for="location_delete">Delete:</label>
                            <div class="col-9">
                                <div class="col-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i>Name</i></span>
