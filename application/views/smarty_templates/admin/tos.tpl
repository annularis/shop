            <div class="col-lg-9" id="admin-tos-form">
                ...
                <div class="col-12">
                    <div class="col-10">Here you can set whether a terms of service must be agreed to before
                ...
                {form method="open" action="admin/tos" attr='class="form-horizontal"'}
                    <div class="form-group">
                        <div class="col-12">
                            <label for="terms_of_service" class="control-label col-3">Terms of Service</label>
                            <div class="col-9"><textarea class="form-control" name="terms_of_service" id="terms_of_service" rows="7" >{$tos|escape:"html":"UTF-8"}</textarea></div>
                        </div>
                    ...
                    <div class='form-group'>
                        <div class="col-12">
                            <label for="terms_of_service_toggle" class="control-label col-3">Display TOS?</label>
                            <div class="col-7">
