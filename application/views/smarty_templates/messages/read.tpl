            ...
            <div class="col-lg-9" id="read-message">
                <h2>View Message</h2>
                ...
                {returnMessage defaultMessage="$defaultMessage" returnMessage="$returnMessage" class="$returnMessage_class"}
                   ...
                   <div class="card bg-light card-body mb-3">
                    <div class="col-12">
                        ...
                        <div class="col-7">{url type="anchor" url=$smarty.capture.t_from_user_url text=$message.from.user_name|escape:"html":"UTF-8" attr=''}</div>
                        <br>
                   </div>

                    <div class="col-12">
                        <div class="col-2"><strong>Subject</strong></div>
                        <div class="col-7">{$message.subject|escape:"html":"UTF-8"}</div>
                        <br>
                    </div>

                    <div class="col-12">
                        <div class="col-2"><strong>Time</strong></div>
                        <div class="col-7">{$message.time_f}</div>
                        <br>
                    </div>

                    {if $message.remove_on_read == TRUE}
                    <div class="col-12">
                        <div class="col-4">This message will now self-destruct..</div>
                    </div>
                    {/if}

                    <div class="col-12">
                        <div class="col-2"><strong>Message</strong></div>
                        <div class="col-9"><br />{$smarty.capture.t_message}</div>
                    </div>
                </div>
