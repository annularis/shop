            ...
            <div class="col-lg-9" id="dispute-transaction">
                ...
                {form method="open" action=$dispute_page attr=['class'=>"form-horizontal"]}
                    <div class='well'>
                        <div class='col-12'>
                            <div class='col-6'>
                                <div class="col-12">
                                    ...
                                    <div class="col-8">{$current_order.created_time_f}</div>
                                </div>

                                <div class="col-12">
                                    <div class="col-4"><strong>Price</strong></div>
                                    <div class="col-8">{$current_order.currency.symbol} {$current_order.price}</div>
                                </div>

                                <div class="col-12">
                                    <div class="col-4"><strong>{ucfirst($other_role)}</strong></div>
                                    <div class="col-8">{url type="anchor" url=$smarty.capture.t_other_user_url text=$smarty.capture.t_other_user_name|escape:"html":"UTF-8" attr=''}</div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <label for="dispute_reason" class="control-label col-3">Dispute Reason</label>
                                <div class="col-7">
                                    <textarea id="dispute_message" name="dispute_message" rows="5" class='form-control'></textarea>
                                </div>
                            </div>
                            <div class="col-9 col-offset-3">{form method="form_error" field="dispute_message"}</div>
                        </div>
                ...
                <div class='well'>
                    <div class='row'>
                        <div class='col-6'>
                            ...
                            <div class="col-6">{$coin.symbol} {number_format($current_order.order_price, 8)}
                            ...
                            <div class="col-6">{url type="anchor" url=$smarty.capture.t_disputing_user_url text=$smarty.capture.t_disputing_user_name|escape:"html":"UTF-8" attr=''}</div>

                        </div>

                        <div class='col-6'>

                            <div class="col-1"><strong>Items:</strong></div>
                            <div class="col-9">
                                <ul>
                                {foreach from=$current_order.items item=item}
                                    <li>{$item.quantity|escape:"html":"UTF-8"} x {$item.name|escape:"html":"UTF-8"}</li>
                ...
                <div class='well'>
                    <h4>Messages</h4>
                        ...
                        <div class='col-12'>
                            <div class="col-2"><strong>Initial Dispute</strong></div>
                        ...
                        {foreach from=$dispute.updates item=update}
                            <div class='col-12'>
                                ...
                                <div class='col-10'>{$update.message|escape:"html":"UTF-8"}</div>
                            </div>
                            <br />
                        {/foreach}
                        </div>
                        ...
                        <div class='form-group'>
                            <div class="col-12">
                                <label class="control-label col-2">Response</label>
                                <div class='col-9'>
