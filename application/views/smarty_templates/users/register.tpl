            <div class="col-lg-9">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10 mx-auto">{form method="form_error" field="user_name"}</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10 mx-auto">{form method="form_error" field="password0"}</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10 mx-auto">{form method="form_error" field="password1"}</div>
                    </div>

                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-2" for="message_pin0">Message PIN</label>
                            <div class="col-5">
                                <input type='password' class="form-control" name='message_pin0' id="message_pin0" value='' autocomplete="off" />
                            </div>
                        </div>
                        <div class="col-10 mx-auto">{form method="form_error" field="message_pin0"}</div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-2" for="pin_alert"></label>
                        <div class="col-5">
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label class="control-label col-2" for="message_pin1">Message PIN (confirm)</label>
                            <div class="col-5">
                                <input type='password' class="form-control" name='message_pin1' id="message_pin1" value='' autocomplete="off" />
                            </div>
                        </div>
                        <div class="col-10 mx-auto">{form method="form_error" field="message_pin1"}</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10 mx-auto">{form method="form_error" field="local_currency"}</div>
                    </div>
